...
- 派生仮説（**要 pre-reg・未検証**）：intraday が系統的に反転するので「ギャップを fade する contrarian intraday」は理論上プラス側。ただし符号を後付けで選ぶのは overfitting、かつ同じ薄商い ETF・slip×2 を払うので、独立 OOS と流動性検証を通すまで主張しない。
